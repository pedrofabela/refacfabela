...
public class ConstantesGenerales {
    ...
    public static final String condicionesPago = "CONTADO"; //constante 
    ...
    public static final String regimenFiscal = "601"; //pendiente
    public static final String usoCFDI = "I04"; // catalogo selecciona caja *****
    public static final String noCertificado = "20001000000300022824";
    public static final String certificado = "";
    public static final String nombreEmisor = "EMISOR";
    public static final String rfcEmisor = "TES030201001";
    public static final String rfcReceptor = "TEST010203001";
    public static final String claveUnidad = "EA"; //  * por definir 
