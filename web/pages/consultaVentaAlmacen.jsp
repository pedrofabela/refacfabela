...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <script type="text/javascript">
     ...
     function consultaCliente(accion, valor, valor2) {
        ...
        function actualizaEntrega(accion, valor) {

            document.forma.ID_VENTA_PRODUCTO.value = valor;
                    ...
                    <s:hidden name="usuariocons.NAMEUSUARIO" id="%{usuariocons.NAMEUSUARIO}"></s:hidden> 
                        ...
                        <article class="articulo1" >
                            ...
                            <s:textfield name="camp.NO_VENTA" id="camp.NO_VENTA" placeholder="Número de Venta" required="true"  cssClass="campoFormBusqueda" onKeyUp="this.value=this.value.toUpperCase();"/>
                              ...
                              <a href="Javascript:guarda('consultaVentaAlmacen')"><div class="boton">  Buscar  </div> </a>
                                ...
                                <div id="scroltabla-cliente">
                                    <div class="contenedor-tab-hist-prog">
                                         <s:url action="GeneraPdf" id="myUrl" escapeAmp="false">
                                                    ...
                                                    <s:param name="TipoReporte" value="'VENTANBUENACONSULTA.jasper'"/>
                                            ...
                                            <s:iterator value="ListaCarroCotizacion" id="  ListaCarroCotizacion" status="stat" >
                                              <tr>
                                                ...
                                                <td id="centrar-dato"><s:property value="DESCRIPCION" /></td>
                                                 ...
                                                 <td id="centrar-dato"><s:if test="ESTATUS_ENTREGA=='ENTREGADO'"> <div style="background: green; width: 100%; color: white; border-radius: 8px;">ENTREGADO</div></s:if><s:else><a href="Javascript:actualizaEntrega('actualizaVentaEstatus','<s:property value="ID_VENTA_PRODUCTO" />')">Entregar</a></s:else></td>
...
<s:textfield type="text" name="camp.ID_VENTA_PRODUCTO" id="ID_VENTA_PRODUCTO"   ></s:textfield>
        </s:form>
